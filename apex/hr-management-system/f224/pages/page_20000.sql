...
,p_group_id=>wwv_flow_imp.id(17629111421652782)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17634351893652805)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17634723455652807)
,p_plug_name=>'&APP_USER.'
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(17635240096652810)
,p_region_id=>wwv_flow_imp.id(17634723455652807)
,p_layout_type=>'ROW'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17635781703652815)
...
,p_plug_item_display_point=>'ABOVE'
,p_list_id=>wwv_flow_imp.id(17633262038652800)
